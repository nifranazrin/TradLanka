                ...
                <div class="checkout-card p-8 rounded-xl shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input class="billing-field w-full px-4" name="fname" required value="{{ Auth::user()->name }}" placeholder="First Name">
                        </div>
                        <div>
                            <label>Last Name <span class="text-gray-400 font-normal">(Optional)</span></label>
                            <input class="billing-field w-full px-4" name="lname" value="{{ Auth::user()->lname ?? '' }}" placeholder="Last Name">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-5">
                        <div>
                            <label>Email</label>
                            <input class="billing-field w-full px-4" name="email" required value="{{ Auth::user()->email }}" placeholder="Email Address">
                        </div>
                        <div>
                            <label>Phone Number</label>
                            <input type="tel" id="phoneInput" class="billing-field w-full px-4" name="phone" value="{{ Auth::user()->phone ?? '' }}">
                    ...
                    <div class="mt-5">
                        ...
                        <select name="country" id="countrySelect" class="billing-field w-full px-4" required>
                            ...
                            @if(session('currency', 'LKR') !== 'USD')
                                <option value="Sri Lanka" data-flag="lk">Sri Lanka</option>
                            @endif
                            <option value="United Arab Emirates" data-flag="ae">United Arab Emirates</option>
                            <option value="Australia" data-flag="au">Australia</option>
                            <option value="Canada" data-flag="ca">Canada</option>
                            <option value="United Kingdom" data-flag="gb">United Kingdom</option>
                            <option value="United States" data-flag="us">United States</option>
                            {{-- Add more as needed --}}
                        </select>
                    </div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <input class="billing-field w-full px-4" name="address1" required 
                                        value="{{ Auth::user()->address1 ?? '' }}" placeholder="House No, Street Name">
                                </div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <input class="billing-field w-full px-4" name="address2" 
                                        value="{{ Auth::user()->address2 ?? '' }}" placeholder="Apartment, Suite, Unit, etc.">
                                </div>
                                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-5">
                        <div>
                            <label>City</label>
                            <input class="billing-field w-full px-4" name="city" required value="{{ Auth::user()->city ?? '' }}" placeholder="City">
                        </div>
                        <div>
                            <label>State</label>
                            <input class="billing-field w-full px-4" name="state" required value="{{ Auth::user()->state ?? '' }}" placeholder="State">
                        </div>
                        <div>
                            <label>Zip Code</label>
                            <input class="billing-field w-full px-4" name="zipcode" required value="{{ Auth::user()->zipcode ?? '' }}" placeholder="Zip Code">
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#countrySelect').on('change', function() {
        ...
        const countryMap = { "Sri Lanka": "lk", "United Kingdom": "gb", "United States": "us", "United Arab Emirates": "ae" };
        if(countryMap[country]) phoneInput.setCountry(countryMap[country]);
    });
