                                ...
                                <div class="text-secondary lh-sm" style="max-width: 250px;">
                                    ...
                                    <span class="small">{{ $order->city }}, {{ $order->state }}</span>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @elseif($order->status == 10) {{--  NEW: Destination Country Milestone --}}
                                                        <span class="badge rounded-pill shadow-sm px-3 py-2 fw-bold text-white" style="background-color: #0d6efd !important;">
                                                            <i class="bi bi-airplane-engines me-1"></i> Arrived at Destination
                                                        </span>
                            ...
                            {{-- 5. DISPATCH ACTIONS --}}
                                <td class="pe-4 text-center">
                                    ...
                                    @elseif($order->status == 10)
                                        {{--  NEW: International Milestone logic --}}
                                        <div class="d-grid gap-1 mb-2">
                                            <span class="badge bg-primary bg-opacity-10 text-primary py-2">
                                                <i class="bi bi-airplane-engines me-1"></i> Arrived in Country
                                            </span>
                                            <small class="text-muted">Awaiting final rider completion</small>
                                        </div>
