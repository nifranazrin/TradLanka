...
<div class="container px-4 mx-auto mt-4 mb-4">
    ...
    <p class="page-subtitle" style="font-size:15px; color:#4b5563;">See what customers are saying about your products</p>
    ...
    <div class="row mb-4 justify-content-center">
        <div class="col-md-8 text-center">
            <div class="btn-group shadow-sm">
                ...
                @for($i=5; $i>=1; $i--)
                    <a href="{{ route('seller.reviews', ['rating' => $i]) }}" 
    ...
    {{-- Fixed Table Card: Removed padding to eliminate the gap --}}
        ...
        <table class="w-full border-collapse" style="table-layout: auto; width: 100% !important;">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50 transition-colors">
                    ...
                    {{-- Clickable Product Link to Frontend --}}
                    ...
                    {{-- Date aligned to the right edge --}}
